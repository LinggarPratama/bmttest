...
const SIgnUp = () => {
  ...
  return (
    ...
    <div className=" w-1/3 mx-auto my-12 content-center">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col mt-4 border shadow-md py-12 px-12 rounded-xl">
      <input
            type="text"
      ...
      <div className="flex flex-col items-center mt-5">
          <p className="mt-1 text-sm font-light text-gray-500">
            Alredy have an account?<a href='/' className="ml-1 font-medium text-blue-400">Register</a>
            </p>
        </div>
    </div>
  </div>
